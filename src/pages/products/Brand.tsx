...
const Brand = () => {
  ...
  const columns: Column<{ id: number; name: string; description: string }>[] = [
    ...
    <div className="mt-2">
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-gray-900 tracking-tight">Product Brands</h1>
            <p className="text-xs sm:text-sm text-gray-600 mt-1 leading-relaxed">Manage product brands</p>
          </div>
          <button
