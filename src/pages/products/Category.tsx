...
const Category = () => {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 tracking-tight">Product Categories</h1>
                ...
                {categories.map((category) => (
                  <tr key={category.id} className="hover:bg-indigo-600 hover:text-white transition-colors group">
                    ...
                    <td className="px-6 py-4 text-right text-sm">
                      ...
                      <button onClick={() => handleDelete(category.id)} className="text-white text-sm font-semibold tracking-wide bg-red-600 group-hover:bg-red-700 hover:bg-red-700 px-2 py-1 rounded">Delete</button>
                    </td>
                  </tr>
                ))}
              </tbody>
